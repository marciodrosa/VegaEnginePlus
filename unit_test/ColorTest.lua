function test_should_create_new_color_with_rgba()
	-- when:
...
function test_should_create_new_color_with_default_values()
	-- when:
	local c = Color.new()
...
function test_colors_should_be_equal()
	-- given
...
function test_colors_should_not_be_equal()
