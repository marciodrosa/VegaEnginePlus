...
function contexttest.test_should_create_new_context()
	...
	assert_nil(context.component, "component should be nil.")
	assert_nil(context.scene, "scene should be nil.")
	assert_nil(context.nextcomponent, "nextcomponent should be nil.")
...
function contexttest.test_should_iterate_by_fields()
	...
	assert_table(t.contentmanager, "Should set the contentmanager in the temp table.")
